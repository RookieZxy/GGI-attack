...
class HuggingFaceLanguageModel(LanguageModel):
    def load_model(self, model_name: str):
        valid_model_names = ["llama-7b-hf", "gpt2-xl", "opt-2.7b", "opt-6.7b", "Llama-3.1-8B", "Llama-3.1-8B-Instruct", "Llama-2-7b-chat-hf","vicuna-7b-v1.5", "Mistral-7B-Instruct-v0.3"]
    ...
    def get_vocab_tokens(self):
        ...
        if "gpt2" in self.model_name:
            ...
            lm_tokenizer = AutoTokenizer.from_pretrained(model_name)
        elif self.model_name == "Llama-2-7b-chat-hf":
